...
The reward calculation algorithm (Algorithm \ref{algo:reward_calculation}) takes statistics from the system and computes the reward based on certain criteria.
